...
class Date {
  ...
  public Date(String s) {
    ...
    if (Date.isValidDate(Integer.parseInt(tokens[0]),Integer.parseInt(tokens[1]),Integer.parseInt(tokens[2]))==false){
        System.exit(0);
    }
  }
  ...
  public static boolean isValidDate(int month, int day, int year) {
    ...
    if ((day > Date.daysInMonth(month,year))||(day < 1)){
        System.exit(0);
    }
  ...
  public static void main(String[] argv) {
    ...
    System.out.println("2300"+Date.isLeapYear(2300));
